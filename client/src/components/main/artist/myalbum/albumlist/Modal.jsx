  ...
  function Modal(props) {
    ...
    const [albumCoverImgFile, setAlbumCoverImgFile] = useState(props.music.img_file);
    ...
    return (
      ...
      <Box
        ...
        sx={{  
          ...
          position:"fixed",top:'25%', left:'40%', width: "550px", height: "600px" }}
      >
        <Box
          sx={{display:'flex'}}
          >
          {albumCoverImgFile && (
            <img align="middle" style={{ width: "260px" }} src={albumCoverImgFile}></img>
            )}
            ...
            >
              <Box
              sx={{width: "100%",fontSize:35, my:4,ml:4}} 
              >
                <p>Music Title</p>
                  <Input sx={{width: "100%"}} value={musicTitle} onChange={changeTitle} />
              </Box>
              
              <Box
              sx={{width: "100%",fontSize:35, my:2,ml:4}} 
              >
              <p>Artist Name</p>
              <div>
                <Input sx={{width: "100%"}} value={contents.artist_name} disabled />
              </div>
              </Box>
            </Box>
        ...
        <div>
          ...
          ></audio>
          <Box
            sx={{width: "100%",fontSize:25, mb:2,ml:1}} 
            >
              <p>genre</p>
          </Box>
          <Box 
        ...
        onClick={()=>{props.setMusicEditModal(false)}}>close</Button>
      </Box>
    );
  }
