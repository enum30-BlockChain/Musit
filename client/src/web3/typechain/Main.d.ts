...
interface MainInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getMintsPerWallet()": FunctionFragment;
    ...
    "setMaxMintsPerTx(uint256)": FunctionFragment;
    "setMaxMintsPerWallet(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMintsPerWallet",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMaxMintsPerTx",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setMaxMintsPerWallet",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "MintMusitNFT(uint256,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MintMusitNFT"): EventFragment;
...
export type MintMusitNFTEvent = TypedEvent<
...
export class Main extends BaseContract {
  ...
  functions: {
    ...
    getMintsPerWallet(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setMaxMintsPerWallet(
      _maxMintsPerWallet: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    getMintsPerWallet(overrides?: CallOverrides): Promise<PopulatedTransaction>;
